...
<body>
    <header class="container-fluid">
        <div class="header-top d-flex justify-content-between align-items-center pb-2">
            <div class="header-right d-flex align-items-center">
                <img id="logo" class="img-fluid" src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/Google_2015_logo.svg/2560px-Google_2015_logo.svg.png" alt="Google logo">
                <h1 class="text-secondary mx-1">Privacy e termini</h1>
            </div>
        ...
        <div class="header-bottom">
            <ul class="d-flex">
                <li><h5 class="text-secondary">Introduzione</h5></li>
                <li class="px-3"><h5 class="text-secondary">Norme sulla privacy</h5></li>
                <li class="px-3"><h5 class="text-secondary">Termini di servizio</h5></li>
                <li class="px-3"><h5 class="text-secondary">Tecnologie</h5></li>
                <li><h5 class="text-primary nav-active">Domande frequenti</h5></li>
            </ul>
        </div>
        <hr>
    </header>
    <main>
        <div class="container_custom pt-5">
            <?php foreach($document_faqs as $single_faq){ ?>
                <?php echo $single_faq["title"] ?> 
